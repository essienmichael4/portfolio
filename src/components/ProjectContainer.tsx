    ...
    <div className='flex flex-col gap-8 w-full mt-8'>
        <div className="border border-gray-300 rounded-2xl p-2">
            <div className="relative border border-gray-300 rounded-2xl px-4 pt-4 lg:px-8 lg:pt-8 overflow-hidden">
                ...
                <a href="https://www.github.com/essienmichael4/bank-management-frontend" target='_blank' rel='noopener noreferrer' className='absolute right-4 top-8 lg:right-8 lg:top-12'>
